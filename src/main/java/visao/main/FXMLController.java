...
import visao.report.RelatorioClienteController;
import visao.report.RelatorioMeioPagController;
import visao.report.RelatorioProdutoController;
...
import visao.search.BuscaPessoaFisicaController;
...
public class FXMLController implements Initializable, MainScreenListener {
    ...
    private void cadastrarLote(ActionEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/details/Lote.fxml"));
